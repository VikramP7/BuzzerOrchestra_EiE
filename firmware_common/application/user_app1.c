...
static u8 songLengthAu8[2][2] = {{42, 24}, {56, 67}};
static u8 instrumentCount = 2;

static u8 songSelection = 1;
...
static void UserApp1SM_IdleChannelOpen();
...
void UserApp1Initialize(void)
{
  ...
  for (u16 packetIndex = 0; packetIndex < songLengthAu8[songSelection][localSongIndex]; packetIndex++)
  {
...
static void UserApp1SM_WaitChannelOpen()
{
  ...
  {
    UserApp1_pfStateMachine = UserApp1SM_IdleChannelOpen;
  }
    ...
    else if (G_eAntApiCurrentMessageClass == ANT_TICK)
    {
      ...
      if (G_au8AntApiCurrentMessageBytes[ANT_TICK_MSG_EVENT_CODE_INDEX] == EVENT_TRANSFER_TX_COMPLETED)
      {
        ...
        if (currentIntrumentIndex < instrumentCount)
        {
          ...
          if (currentInstrumentPacket >= songLengthAu8[songSelection][currentIntrumentIndex])
          {
